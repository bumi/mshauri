<template>
  <div class="w-80 mx-auto flex relative py-2">
    <div class="absolute h-100 w-10 flex align-items-center justify-content-center">
      <div class="h-100 w-05 bg-grey-light"></div>
    </div>
    ...
    <div class="w-90 py-5">
      <router-link tag="div" class="cursor-pointer"
        ...
        <div class="w-95 ml-auto bg-transparent border-grey-light shadow-sm border-solid border-1 rounded-xl">
          <h4 class="text-lg pt-4 pb-2 p-0 m-0 pl-5 font-bold">{{ recommendation.title }}</h4>
            <p class=" text-sm p-0 m-0 pl-5 pb-4 font-roboto font-light"> {{ recommendation.intro }}</p>
        </div>
      </router-link>
    </div>
  </div>
